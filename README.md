...
## 🚀 Installation
1. Download the `.json` or asset folder from the latest [Releases](../../releases).
2. Connect your device's SD card to your computer.
3. Copy the files into the `/themes` directory.
4. Reboot your device and select the theme from the Bruce settings menu.
